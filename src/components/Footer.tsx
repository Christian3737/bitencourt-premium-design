      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex items-center justify-center gap-6 my-4">
          <a
            ...
            className="flex items-center gap-2 text-surface-dark-foreground/70 hover:text-primary transition-colors text-sm"
          >
            <MessageCircle className="size-5" />
            (65) 9 9955-5263
          </a>
          <a
            href="https://www.instagram.com/bitencourtvidros16"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-surface-dark-foreground/70 hover:text-primary transition-colors text-sm"
          >
